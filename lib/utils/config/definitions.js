...
define('provenance', {
  default: null,
  hint: 'true | <provenance-path>',
  type: [null, Boolean, path],
  description: `
    Indicates that a provenance statement should be generated (true) or
    provides a path to an existing provenance statement.
  `,
  flatten,
})
